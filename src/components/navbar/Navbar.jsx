      ...
      <div className="navbar flex items-center mt-11 w-full justify-center space-x-8">
        ...
        <NavLink to="/product" className="group">
          {({ isActive }) => (
            <>
              <p
                className={`relative before:content-[''] before:absolute before:left-0 before:-bottom-2 before:h-0.5 before:w-full before:transition-transform before:duration-300 ${
                  isActive ? "before:scale-x-100 before:bg-gray-100" : "before:scale-x-0 before:bg-gray-800 group-hover:before:scale-x-100"
                }`}
              >
                DRONE
              </p>
        ...
        <NavLink to="vision" className="group">
          {({ isActive }) => (
            <>
              <p className={`relative before:content-[''] before:absolute before:left-0 before:-bottom-2 before:h-0.5 before:w-full before:transition-transform before:duration-300 ${
                  isActive ? "before:scale-x-100 before:bg-gray-100" : "before:scale-x-0 before:bg-gray-800 group-hover:before:scale-x-100"
                }`}>
            VISION
          </p>
